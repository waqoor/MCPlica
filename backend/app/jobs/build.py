...
def _pipeline(
    ...
    *,
    ...
    async def resolve_openrouter_key() -> str | None:
        # Resolving involves a database round-trip plus decryption; every
        # OpenRouter request calls this, so cache the result for the
        # lifetime of this build job instead of re-fetching it every time.
