...
This document defines the tested `1.0.0-rc.2` candidate boundaries and planned `1.0.x` support
...
| Surface                     | v1.0.0-rc.2 contract                                        | Compatibility rule                                                                                                               |
| --------------------------- | ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| Product/packages/API/images | `1.0.0-rc.2` from root `VERSION`                            | Release tag must be exactly `v1.0.0-rc.2`; all copies are CI-checked                                                             |
...
| Generic runtime             | `1.0.0-rc.2`                                                | A build declares a PEP 440-compatible runtime range and deployment checks it before activation                                   |
...
| macOS with Docker Desktop                          | Not certified for v1.0.0-rc.2    | Expected development path only; no release evidence currently proves the full dynamic-runtime workflow                                                                          |
| Linux arm64                                        | Not certified for v1.0.0-rc.2    | Upstream images may be multi-architecture, but the complete release candidate has no arm64 acceptance evidence                                                                  |
| Kubernetes, Swarm, Podman, rootless Docker         | Not supported by v1.0.0-rc.2     | No alternate deployment architecture or compatibility layer is shipped                                                                                                          |
