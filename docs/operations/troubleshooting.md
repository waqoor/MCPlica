...
| ----------------------------------------------------- | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Compose reports `MCPLICA_VERSION` missing             | Existing `.env` predates v1 version authority                                | Add `MCPLICA_VERSION=1.0.0-rc.2`, remove obsolete `MCP_RUNTIME_VERSION`, rerun `config --quiet`                                                                                                                                                                                                                                                                                     |
