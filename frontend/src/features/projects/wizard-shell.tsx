...
export function WizardShell({
  ...
  return (
    <>
      ...
      <main
        className="mx-auto min-h-screen w-full max-w-6xl px-4 py-5 sm:px-6 sm:py-7 lg:px-8"
        id="main-content"
        tabIndex={-1}
      >
        <header className="mb-7 border-b border-border pb-5">
          <div className="mb-6 flex items-center justify-between gap-4">
            <Link
              ...
              className="-m-1 rounded-lg p-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-canvas"
              to="/"
            >
              <BrandLogo
                alt=""
                className="h-9 w-[9.5rem] sm:h-10 sm:w-[10.5rem]"
                loading="eager"
              />
            </Link>
            <span className="font-mono text-[0.62rem] uppercase tracking-[0.13em] text-muted">
              API → MCP
            </span>
          </div>
          ...
          <div className="mt-2 flex flex-wrap items-end justify-between gap-4">
            ...
            <Link
              className="inline-flex min-h-11 items-center text-sm font-medium text-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
