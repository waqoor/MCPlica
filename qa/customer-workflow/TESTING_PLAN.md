...
- **CI/release automation, SBOM/signing, dependency scanning** (`docs/release/`) — supply-chain concerns with their own release-gate process, not part of the customer-facing journey.
